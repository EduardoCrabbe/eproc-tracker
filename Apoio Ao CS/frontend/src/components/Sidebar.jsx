...
import { LayoutDashboard, Users, Trophy, Activity, Calculator, Settings, LogOut } from 'lucide-react';
...
export default function Sidebar({ role }) {
  ...
  return (
    <aside className="w-64 bg-brand-navy flex flex-col shadow-xl text-white">
      ...
      <div className="p-6">
        ...
        <button className="flex items-center gap-2 text-white/70 hover:text-white transition-colors text-sm font-medium px-2 py-2">
